...
## v1.0.0-rc.6 (2025-06-19)

### Bug Fixes

- Hardcode versions
  ([`6eda9eb`](https://github.com/nk46-cloud/py-maidr/commit/6eda9eb91b73c95605d430e72a32562443ea51f5))

### Chores

- Fix versions
  ([`3baa385`](https://github.com/nk46-cloud/py-maidr/commit/3baa385adb68af9224041df4778322980eced01c))


## v1.0.0-rc.5 (2025-06-19)

### Bug Fixes

- Update semantic-release configuration and workflow permissions
  ([`bcac120`](https://github.com/nk46-cloud/py-maidr/commit/bcac1208c4b625c87346f24958eb4ad81df5117f))


## v1.0.0-rc.4 (2025-06-19)

### Bug Fixes

- Update semantic-release configuration for changelog commits
  ([`60d5419`](https://github.com/nk46-cloud/py-maidr/commit/60d54196a66421e78e7feb5db6dd7002761f927a))


## v1.0.0-rc.3 (2025-06-19)

### Bug Fixes

- Ensure changelog is included in release commits
  ([`8046e14`](https://github.com/nk46-cloud/py-maidr/commit/8046e145945dd24d7cdb9005f927c912d0bdd06e))


## v1.0.0-rc.2 (2025-06-19)

### Bug Fixes

- Update semantic-release changelog configuration format
  ([`9cb10bc`](https://github.com/nk46-cloud/py-maidr/commit/9cb10bc2db8187154a62b66bb2f97f86d2caac10))


## v1.0.0-rc.1 (2025-06-19)
...
- Cl update
  ([`7103789`](https://github.com/nk46-cloud/py-maidr/commit/71037892b14c70bff69f78bf92e95288e1c4829b))
...
- Trigger patch version bump for testing
  ([`f356ef8`](https://github.com/nk46-cloud/py-maidr/commit/f356ef81de99501a9a80103730328e4140caabdf))

- Update changelog configuration to be more permissive
  ([`bc8a581`](https://github.com/nk46-cloud/py-maidr/commit/bc8a58142eded35d445f362c436afbfd786bdb4e))
...
- Update semantic release branch configuration
  ([`4f38266`](https://github.com/nk46-cloud/py-maidr/commit/4f3826600a1583a17bb1dd977eb013ae21902995))

- Add explicit fix/stest branch configuration - Enable zero version handling - Remove catch-all
  branch configuration - Set proper prerelease settings
...
- **changelog**: Update changelog configuration
  ([`e656f98`](https://github.com/nk46-cloud/py-maidr/commit/e656f98b9949469d9182d47ee04c47e6f308383e))
...
- Refactor ([#95](https://github.com/nk46-cloud/py-maidr/pull/95),
...
- Test release action
  ([`9acc643`](https://github.com/nk46-cloud/py-maidr/commit/9acc643cc840eaa0aa0b884ad919749784fc992c))

- Test release action
  ([`3baf5ef`](https://github.com/nk46-cloud/py-maidr/commit/3baf5ef8fe92eae499f3a9d899d6037f63562cb8))

- Test release action
  ([`4cb093f`](https://github.com/nk46-cloud/py-maidr/commit/4cb093f13eff5c01a78218b9e44974b437aa23b6))
...
- Update gh actions
  ([`32173c8`](https://github.com/nk46-cloud/py-maidr/commit/32173c8107d89bded1643525db7b61a787446e1f))
...
- Update python-semantic-release to v10.1.0
  ([`0b08788`](https://github.com/nk46-cloud/py-maidr/commit/0b087884058fb3f0f68871c8f368329a8fd5575b))
...
- Rectify commit-lint job crash ([#92](https://github.com/nk46-cloud/py-maidr/pull/92),
...
- Release bar imp
  ([`08b61d8`](https://github.com/nk46-cloud/py-maidr/commit/08b61d88a5cc19f07bf389a89406ff4a296b2e68))
...
- Test release action
  ([`445dd52`](https://github.com/nk46-cloud/py-maidr/commit/445dd528f38fb0d9d874a49f0a01d61662eb4b77))
...
- Update version management for semantic release
  ([`c191f70`](https://github.com/nk46-cloud/py-maidr/commit/c191f702ebceb930640d3ab52267e34238bd4bfd))

BREAKING CHANGE: Update version tracking to align with semantic release workflow
...
- **boxplot**: Support horizontal orientation
...
- Update version tracking to align with semantic release workflow
